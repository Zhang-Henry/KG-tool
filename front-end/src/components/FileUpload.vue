    ...
    <el-container class="main-container">
        ...
        <el-container>
            ...
            <el-main class="main">
                ...
                style="width:600px;margin-left:auto;margin-right:auto;margin-top:10px;">
                ...
                <el-card class="box-card" style="width:600px;margin-left:auto;margin-right:auto;margin-top:30px;">
                    <el-tabs v-model="activeTab" type="card" @tab-click="handleClick">
                    <el-tab-pane label="实体文件" name="first">
                        <el-upload class="upload-demo"
                        drag
                        action="http://127.0.0.1:8000/uploadentity/"
                        multiple>
                        <i class="el-icon-upload"></i>
                        <div class="el-upload__text">将实体文件拖到此处，或<em>点击上传</em></div>
                        <div class="el-upload__tip" slot="tip">只能上传csv/xls/xlsx文件</div>
                        </el-upload>
                    </el-tab-pane>
                    <el-tab-pane label="关系文件" name="second">
                        <el-upload class="upload-demo" drag action="http://127.0.0.1:8000/uploadrelation/" multiple>
                        <i class="el-icon-upload"></i>
                        <div class="el-upload__text">将关系文件拖到此处，或<em>点击上传</em></div>
                        <div class="el-upload__tip" slot="tip">只能上传csv/xls/xlsx文件</div>
                        </el-upload>
                    </el-tab-pane>
                    </el-tabs>
