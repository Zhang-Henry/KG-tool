              ...
              <div class="ef-tooltar">
                ...
                <div style="float: right; margin-right: 5px">
                  <el-button
                    ...
                    >流程信息</el-button
                  >
                  <el-button type="info" round size="mini" @click="nextStep"
                    >下一步</el-button
                  >
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    nextStep() {
      ...
      axios
        .post(
          "http://localhost:8000/creategraph/" + fileName + "/",
          ...
          if (this.lineColor == "#E0E3E7") {
            ...
            for (var i = 0; i < lines.length; i++) {
              if (lines[i]._jsPlumb.paintStyle["stroke"] == "#E0E3E7") {
                lines[i].setHoverPaintStyle({
                  outlineStroke: "trasparent",
                  outlineWidth: 3,
                  stroke: "#b0b2b5",
                  strokeWidth: 1,
                });
